...
export class PaymentService {
    ...
    try {
      ...
      const transactionDetails = {
        ...
        customer_details: {
          ...
          email: `${santri.nisn}@al-ikhlas.com`, // mock email
  ...
  async handleMidtransWebhook(notificationPayload: any) {
    try {
      ...
      this.logger.log(
        `Menerima Notification Midtrans Order: ${orderId} | Status: ${transactionStatus}`,
      );
      ...
      if (transactionStatus === 'capture' || transactionStatus === 'settlement') {
        ...
        this.logger.log(
          `Transaksi ${orderId} gagal/batal (${transactionStatus}). Tidak memotong/menambah saldo apapun.`,
        );
      }

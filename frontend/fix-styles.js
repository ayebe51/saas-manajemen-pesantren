...
const styleReplacements = [
  // Text Colors
  { regex: /style=\{\{\s*color:\s*['"`]var\(--text-main\)['"`]\s*\}\}/g, classString: ' text-main' },
  { regex: /className="([^"]+)"\s*style=\{\{\s*color:\s*['"`]var\(--text-main\)['"`]\s*\}\}/g, replace: 'className="$1 text-main"' },
  
  // Border Colors
  { regex: /style=\{\{\s*borderColor:\s*['"`]var\(--border-light\)['"`]\s*\}\}/g, classString: ' border-light' },
  { regex: /className="([^"]+)"\s*style=\{\{\s*borderColor:\s*['"`]var\(--border-light\)['"`]\s*\}\}/g, replace: 'className="$1 border-light"' },

  // Background Colors standalone
  { regex: /className="([^"]+)"\s*style=\{\{\s*backgroundColor:\s*['"`]var\(--color-primary\)['"`]\s*\}\}/g, replace: 'className="$1 bg-primary"' },
  { regex: /className="([^"]+)"\s*style=\{\{\s*backgroundColor:\s*['"`]var\(--color-accent\)['"`]\s*\}\}/g, replace: 'className="$1 bg-accent"' },
  { regex: /className="([^"]+)"\s*style=\{\{\s*backgroundColor:\s*['"`]var\(--bg-app\)['"`]\s*\}\}/g, replace: 'className="$1 bg-app"' },
  { regex: /className="([^"]+)"\s*style=\{\{\s*backgroundColor:\s*['"`]var\(--bg-surface\)['"`]\s*\}\}/g, replace: 'className="$1 bg-surface"' },
];
